CREATE TABLE [dbo].[Department_Note_User] (
    ...
    CONSTRAINT [PK_Department_Note_User] PRIMARY KEY CLUSTERED ([Notification_id_notification] ASC, [Department_id_department] ASC, [User_id_user] ASC),
    CONSTRAINT [FK_GNU_id_deparment] FOREIGN KEY ([Department_id_department]) REFERENCES [dbo].[Department] ([id_department]),
